...
public class PropostaSemIntegracao {
    ...
    public PropostaSemIntegracao(PropostaRepository propostaRepository,
                                 ...
                                 @Value("proposta-pendente.ex") String exchange) {
